...
EXTRA="--decoder-type lgm --s2p2-layers 2 --target-rate -1 --tbptt --s2p2-scan --lgm-timescales 6 --lgm-ground-file data/kirchner_ground_sol.json --lgm-freeze-ground --lgm-gate-max 2.0"
TAG="lgm-tl-s${SEED}"
SAMPLER=inversion
