...
EXTRA="--decoder-type ss2p2 --s2p2-layers 2 --ss2p2-wnorm-cap 6.0 --target-rate -1 --tbptt --s2p2-scan --disp-loss-weight 20 --disp-scales 0.5,2,8,32"
TAG="ss2p2-w4kd-s${SEED}"
SAMPLER=thinning
