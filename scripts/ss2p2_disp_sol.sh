...
EXTRA="--decoder-type ss2p2 --s2p2-layers 2 --ss2p2-wnorm-cap 12.0 --target-rate -1 --tbptt --s2p2-scan --disp-loss-weight 20 --ss2p2-freeze-spectrum"
TAG="ss2p2-disp-s${SEED}"
SAMPLER=thinning
