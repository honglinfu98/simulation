...
| `train_bfnx.py` | Modified trainer: decoder flags + post-step `project_subcritical`. | — |

`volume_set_mtpp.py` / `train_bfnx.py` are **vendored from volume-set-mtpp with our edits** —
